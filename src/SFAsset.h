 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_SKULL, SFASSET_COIN, SFASSET_WALL, SFASSET_KEY, SFASSET_DOOR, SFASSET_END};
...
public:
  ...
  virtual bool      DetectLeftCollision(shared_ptr<SFAsset>);
  virtual bool      DetectRightCollision(shared_ptr<SFAsset>);
  virtual bool      DetectTopCollision(shared_ptr<SFAsset>);
  virtual bool      DetectBottomCollision(shared_ptr<SFAsset>);
